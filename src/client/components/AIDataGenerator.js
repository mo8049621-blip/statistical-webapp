    ...
    var handleGenerate = function () {
        ...
        setTimeout(function () {
            try {
                ...
                var data = generateMockDataBasedOnDescription(dataDescription, sampleSize);
                onDataChange(data, {
                    type: 'ai',
